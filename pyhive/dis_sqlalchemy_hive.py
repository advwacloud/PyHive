"""Integration between dis_sqlalchemy and Hive.

Some code based on
https://github.com/zzzeek/dis_sqlalchemy/blob/rel_0_5/lib/dis_sqlalchemy/databases/sqlite.py
...
try:
    from dis_sqlalchemy import processors
except ImportError:
    # Required for dis_sqlalchemy>=2.0
    from dis_sqlalchemy.engine import processors
from dis_sqlalchemy import types
from dis_sqlalchemy import util
# TODO shouldn't use mysql type
try:
    from dis_sqlalchemy.databases import mysql
...
from dis_sqlalchemy.sql.compiler import SQLCompiler
...
class HiveExecutionContext(default.DefaultExecutionContext):
    ...
    http://docs.dis_sqlalchemy.org/en/latest/dialects/sqlite.html#dotted-column-names
